...
@export var radius_min : float = 8.0
@export var radius_max : float = 32.0 
@export var radius : float = 30.0 : set = set_crosshair_radius
@export var thickness : float = 1.0 : set = set_crosshair_thickness
@export var color : Color = Color.GHOST_WHITE : set = set_crosshair_color
@export var static_color : Color = Color.LIGHT_GRAY : set = set_crosshair_color_static
...
func _draw() -> void:
	...
	draw_static_crosshair()


func draw_static_crosshair():
	var static_points = [
		Vector2(0,-radius_min),
		Vector2(0,-radius_max),
		Vector2(-radius_min,0),
		Vector2(-radius_max,0),
		Vector2(0,radius_min),
		Vector2(0,radius_max),
		Vector2(radius_min,0),
		Vector2(radius_max,0)
	]
	draw_multiline(static_points, static_color, thickness, true)
...
func set_crosshair_color_static(new_color):
